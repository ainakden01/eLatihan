...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'no-reply@pojsmtp.kehakiman.gov.my';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'NO REPLY PKPMP';
   ...
   * @var string
   */
  public $Host          = 'pojsmtp.kehakiman.gov.my';
   ...
   * @var string
   */
  public $Username      = 'no-reply@pojsmtp.kehakiman.gov.my';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'Hamakham2018';
